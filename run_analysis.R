...
# vector with position of these variables
indx <-c(1:6,41:46,81:86,121:126,161:166,201:202,214:215,227:228,240:241,253:254,266:271,345:350,424:429,503:504,516:517,529:530,542:543)
...
#First melt the data, so that all variables are collapsed in two columns: variable (with the variable name) and value (the value of that variable - mean or sd)
